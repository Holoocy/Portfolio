    ...
    <div>
      <Container>
        <Row>
          <Col md={4}></Col>
          <Col className="p-2">
            <Row className="fs-6 p-2 fst-italic mt-5" md={1}>
              WHO I AM
            </Row>
          </Col>
          <Col className=" p-2 fs-3 mt-4" md={7}>
            <span className="display-5">I</span> am a software developer with
            extensive knowledge and years of hands-on experience in the TECH
            industry.
          </Col>
        </Row>
        <Row>
          <Col md={4} className=" p-2 h-100 d-inline-block">
            <img
              className="img-fluid rounded w-75 ms-5"
              src={image}
              alt="My Image"
            />
            <Col className="ps-5 mt-4">
              <svg
                               ...
                               0-6.2-.3-40.4-.3-61.4 0 0-70 15-84.7-29.8 0 0-11.4-29.1-27.8-36.6 0 0-22.9-15.7
                                1.6-15.4 0 0 24.9 2 38.6 25.8 21.9 38.6 58.6 27.5 72.9 20.9 2.3-16 8.8-27.1
                                 16-33.7-55.9-6.2-112.3-14.3-112.3-110.5 0-27.5 7.6-41.3 23.6-58.9-2.6-6.5-11.1-33.3
                                  ...
                                  69-27 13.7 34.7 5.2 61.4 2.6 67.9 16 17.7 25.8 31.5 25.8 58.9 0 96.5-58.9 104.2-114.8 110.5
                                  9.2 7.9 17 22.9 17 46.4 0 33.7-.3 75.4-.3 83.6 0 6.5 4.6 14.4 17.3 12.1C428.2 457.8 496 362.9 496
                                   252 496 113.3 383.5 8 244.8 8zM97.2 352.9c-1.3 1-1 3.3.7 5.2 1.6 1.6 3.9 2.3 5.2 1 1.3-1
              ...
              <a className="ms-3">https://github.com/Holoocy</a>
            </Col>
            <Col className="ps-5 mt-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="1.5em"
                viewBox="0 0 448 512"
                  ...
                  d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9
                               480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4
                                ...
                                102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1
                                 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66
                                 .4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"
                />
              </svg>
              <a className="ms-3">
                https://www.linkedin.com/in/gbenga-olusi-662204162/y
              </a>
            </Col>
          </Col>
          <Col className=" px-5">
            <Row>
              <Col className="fs-5 ps-2 m-4">
                My background is in Electrical and Electronics Engineering
                <br></br>
                but my longtime love for software developmeent attracted me
                back...
              </Col>
              <Col className="fs-5 ps-2 m-4">
                I'm driven by my desire for personal growth and efficiency,
                <br></br>
                improving every day in the field and reaching the highest
                possible...
              </Col>
            </Row>
            <Col className="display-4 text-center">Work Experience</Col>
            <hr></hr>
            <Row className=" ps-2">
              <Col>
                <h4 className="fs-3 ps-2">Imoye Consult</h4>
            ...
            <Row className=" ps-2">
              <Col>
                <h4 className="fs-3 ps-2">Innotelligent Tech&Consult</h4>
            ...
            {/*  <Col className=" p-2">
              irgdfh iohtjohgjio ojgetrhio koftjhwreios ohtehiorsnk nokbiodrnio
              nobiori onoersio onfgiosedion okdngriosn nofgosid onfdgosid
              nodforsiod noferioui koetrkoteriot okthrohteo eokgwon nklrekok
              ejioegorio jeotjio jiotejo oeyo oeryoh norny nreoion owenfni
            </Col> */}
          </Col>
        </Row>
      </Container>
